  ...
  return (
    ...
    >
      ...
      <nav
        ...
        className="hidden lg:flex z-30 absolute left-8 top-1/2 -tranteal-y-1/2 flex-col gap-3"
      >
        {SOCIALS.map((s) => (
          <a
            key={s.id}
            ...
            aria-label={s.label}
            className="w-10 h-10 flex items-center justify-center border border-white/8 bg-black/40 text-white rounded-lg hover:bg-teal-300 hover:text-black transition-transform transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-300"
          >
      ...
      >
        ...
        >
          I craft{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-teal-400">
            fast, accessible
          </span>{" "}
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <motion.a
            ...
            className="inline-flex items-center gap-3 px-6 py-3 rounded-lg font-semibold text-black bg-gradient-to-b from-teal-500 to-teal-600 shadow-lg focus:outline-none focus:ring-4 focus:ring-teal-300/30"
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-3 px-4 py-2 rounded-lg font-medium text-white border border-white/10 bg-black/30 hover:bg-white hover:text-black transition focus:outline-none focus:ring-2 focus:ring-teal-300"
        ...
        <div className="flex lg:hidden justify-center gap-3 mt-6">
          {SOCIALS.map((s) => (
            <a
              ...
              rel="noopener noreferrer"
              aria-label={s.label}
              className="w-9 h-9 flex items-center justify-center border border-white/8 bg-black/40 text-white rounded-md hover:bg-white hover:text-black transition-transform transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-300"
            >
              <FontAwesomeIcon icon={s.icon} className="text-sm" aria-hidden />
            </a>
          ))}
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute top-10 right-8 w-16 h-16 rounded-full blur-xl opacity-70 bg-gradient-to-tr from-teal-400/40 to-teal-400/30"
      />
