        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-b from-pink-500 to-pink-600 text-black font-semibold shadow-md focus:outline-none focus:ring-4 focus:ring-pink-300/30"
              >
                Hire me
              </a>
            </div>
          ...
          <div className="lg:col-span-3 grid sm:grid-cols-2 gap-6">
            {services.map((s, i) => {
              ...
              const bgClass = isActive
                ? "bg-gradient-to-b from-pink-400/95 to-pink-500/95 text-black border-transparent shadow-2xl"
              ...
              return (
                <button
                  ...
                  className={`group relative flex flex-col items-start gap-4 p-6 rounded-2xl transform-gpu transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-pink-300/20 ${bgClass}`}
