    ...
    >
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <span className="inline-flex items-center px-3 py-1 rounded-md border border-blue-500 bg-black/30 text-blue-400 text-sm font-medium">
              About
            </span>
            ...
            <ul className="mt-6 flex flex-wrap gap-2">
              {["React", "Tailwind", "Accessibility", "Performance"].map(
                (t) => (
                  <li key={t}>
            ...
            <dl className="w-full max-w-xs mt-2 grid grid-cols-2 gap-4">
              {stats.map((s, i) => (
                ...
                >
                  ...
                  <dd className="text-2xl font-extrabold text-blue-400 leading-none">
                    {s.value}
                  </dd>
