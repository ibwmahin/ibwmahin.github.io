...
const ProjectCard: React.FC<{
  ...
  return (
    <div
      ...
      className="group relative overflow-hidden rounded-xl cursor-pointer border border-white/6 transition-transform duration-300 ease-out transform hover:-translate-y-1 hover:scale-[1.01] focus:outline-none focus:ring-4 focus:ring-pink-300/20"
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-2 rounded-md border border-white/6 text-white bg-transparent hover:bg-white/6 focus:outline-none focus:ring-4 focus:ring-pink-300/20"
            >
              ◀
            </button>
            <button
            ...
            <button
              ...
              className="ml-2 px-3 py-2 rounded-md text-white bg-transparent hover:bg-white/6 focus:outline-none focus:ring-4 focus:ring-pink-300/20"
            >
              ✕
            </button>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-6 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="px-3 py-2 rounded-md text-sm w-56 bg-black border border-white/6 text-white placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-pink-300/20"
          ...
          <div className="mb-6 flex gap-2 flex-wrap">
            {detectedMajors.map((cat) => (
              <button
                ...
                className={`text-xs font-medium px-3 py-1 rounded-md transition focus:outline-none focus:ring-4 focus:ring-pink-300/20 ${
                  activeCategory === cat
              ...
              <div className="mt-8 text-center">
                {!expanded ? (
                  <button
                    ...
                    className="px-5 py-2 rounded-md border border-white/6 font-semibold text-white bg-transparent focus:outline-none focus:ring-4 focus:ring-pink-300/20"
                  >
