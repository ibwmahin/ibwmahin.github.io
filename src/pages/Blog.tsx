  ...
  const blogPosts = [
    {
      ...
      excerpt: "Learn how to create flexible, responsive components using Tailwind CSS utility classes and modern CSS techniques. This comprehensive guide covers grid systems, flexbox layouts, and responsive design patterns.",
      date: "2024-01-15",
      readTime: "5 min read",
      category: "CSS",
    ...
    },
    {
      ...
      excerpt: "Deep dive into React's performance optimization hooks and when to use them effectively in your applications. Understanding the differences and best practices for optimal performance.",
      date: "2024-01-10",
      readTime: "8 min read",
      category: "React",
    ...
    },
    {
      ...
      excerpt: "Explore the latest JavaScript features and how they can improve your development workflow and code quality. From array methods to async improvements.",
      date: "2024-01-05",
      readTime: "6 min read",
      category: "JavaScript",
    ...
    },
    {
      ...
      excerpt: "Master the art of web animations using Framer Motion. Learn about transitions, gestures, and complex animation sequences that enhance user experience.",
      date: "2023-12-28",
      readTime: "7 min read",
      category: "Animation",
    ...
    },
    {
      ...
      excerpt: "Learn essential TypeScript patterns and best practices for building robust React applications. Type safety, interfaces, and advanced TypeScript features.",
      date: "2023-12-20",
      readTime: "9 min read",
      category: "TypeScript",
    ...
    },
    {
      ...
      excerpt: "Discover powerful CSS Grid techniques for creating complex layouts with minimal code. From basic grids to advanced responsive designs.",
      date: "2023-12-15",
      readTime: "6 min read",
      category: "CSS",
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Sharing my thoughts, experiences, and tutorials about web development, 
                programming, and the latest technologies in the industry.
              </p>
            </motion.div>
          </div>
        </section>
