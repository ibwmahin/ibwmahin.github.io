      ...
      <div className="max-w-6xl mx-auto px-6 pt-24">
        ...
        >
          ...
          >
            ...
            applish look — clean cards, soft shadows and subtle glass.
          </motion.p>
        </motion.header>
          ...
          {allPosts.map((post: Post) => {
            ...
            return (
              <motion.article
                key={post.slug}
                variants={item}
                className={`relative overflow-hidden rounded-2xl border bg-card/60 backdrop-blur-md p-4 shadow-md hover:shadow-xl transition-all ${featured}`}
              >
